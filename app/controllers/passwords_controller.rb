class PasswordsController < ApplicationController
  ...
  def create
    # La méthode .permit permet de définir les paramètres qu'on autorise dans le require
  ...
  def  update
    ...
    if @user.recover_password ===  user_params[:recover_password]
      ...
      if @user.valid?
        ...
        redirect_to profil_path, success: "Votre mot de passe a bien ete modifie"
